...
namespace Havas.Common.DAO
{
    ...
    /// </summary>
    public sealed class HibernateManager
    {
        ...
        /// <summary>
        /// Gets the default size of the ADO batch.
        /// </summary>
        /// <value>The default size of the ADO batch.</value>
        public int DefaultAdoBatchSize
        {
            get { return _sessionFactory.Settings.AdoBatchSize; }
        }
        ...
        {
            internal static readonly HibernateManager SessionManager =
        ...
        public void CloseSession()
        {
            ...
            if (session != null && session.IsOpen)
            {
                // session.Flush();  // this generates another exception that says "dont flush the Session after an exception occurs"
                session.Close();
            }
