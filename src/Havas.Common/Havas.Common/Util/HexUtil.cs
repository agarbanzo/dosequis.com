...
namespace Havas.Common.Util
{
    public static class HexUtil
    {
        ...
        public static string UnicodeStringToHexString(string UnicodeString)
        {
            var unicodeEncoding = new System.Text.UnicodeEncoding();
            return ByteArrayToHexString(unicodeEncoding.GetBytes(UnicodeString));
        }

        public static string HexStringToUnicode(string HexString)
        {
            var unicodeEncoding = new System.Text.UnicodeEncoding();
            return unicodeEncoding.GetString(HexStringToByteArray(HexString));
        }
